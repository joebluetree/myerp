...
/// <summary>
/// Composition entry point for the Inventory module. The host calls this once at
/// startup; nothing outside this file registers Inventory services.
/// </summary>
public static class DependencyInjection
{
    ...
    /// </summary>
    public static IMvcBuilder AddInventoryModule(this IMvcBuilder mvc, IConfiguration configuration)
    {
